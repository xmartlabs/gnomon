...
#   inputs: the qualified planning numerator now admits plan mode, and a plan_ceremony_calls
...
#           dropped the now-false "skill", and planning ceremony left both sides of the
#           explore-to-doing ratio.
